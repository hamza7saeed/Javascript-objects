...
var a = createPersonFactory("Hamza Saeed", 27, "Pakistan");
a.intro();
/*
...
*/
function PersonConstructor(name, age, nationality) {
    this.Name = name;
    this.Age = age;
...
var b = new PersonConstructor("Hamza Saeed", 27, "Pakistan");
console.log(b);
/*
### Assignment 2:
...
*/
var simpleDataObject = {
    stdName: "Hamza Saeed",
    stdAge: 27,
    student: true,
    student_properity: function () {
...
var g = Object.create(functionObject);
g.gret("Hamza");
var h = Object.create(functionObject);
h.name = "Peterson";
h.greet();
h.add(5);
